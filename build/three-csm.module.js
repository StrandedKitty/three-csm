import { Vector3, ShaderChunk, DirectionalLight, Vector2, LineBasicMaterial, Object3D, Geometry, Line } from 'three';
...
class CSM {
	...
	update(cameraMatrix) {
		for(let i = 0; i < this.frustums.length; i++) {
			...
			let p = new Vector3(bb.center.x, bb.center.y, bb.center.z);
